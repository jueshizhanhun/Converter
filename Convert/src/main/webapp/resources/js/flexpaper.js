...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:"resources/js/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:"resources/css/");
    ...
    window[instance] = flashembed(id, {
        ...
        version					    : [10, 0],
        expressInstall			    : "resources/js/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
